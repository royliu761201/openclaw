import { A as theme, G as resolveGatewayPort, L as DEFAULT_GATEWAY_PORT, k as isRich, m as restoreTerminalState, p as defaultRuntime, y as info } from "./entry.js";
import { At as DEFAULT_CONTEXT_TOKENS, F as resolveConfiguredModelRef, Mt as DEFAULT_PROVIDER, jt as DEFAULT_MODEL, v as ensureAuthProfileStore } from "./auth-profiles-DIgZUMSR.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-Bxe0mWee.js";
import { l as normalizeAgentId, y as parseAgentSessionKey } from "./session-key-DVvxnFKg.js";
import { h as pathExists, y as resolveUserPath } from "./utils-BLJAc3ZV.js";
import { n as runExec } from "./exec-CPPvAI1K.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BKsZvO6K.js";
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-DpnW8E9V.js";
import { P as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-TOMBPbi7.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-xx1k4_sV.js";
import { h as readTailscaleStatusJson, m as getTailnetHostname, p as findTailscaleBinary } from "./auth-DS2aFsxs.js";
...
import { Fn as summarizeRestartSentinel, J as buildChannelSummary, Jt as formatUsageReportLines, Lr as getMemorySearchManager, Pn as readRestartSentinel, Pt as sha256HexPrefix, S as waitForGatewayReachable, T as normalizeControlUiBasePath, Z as getRemoteSkillEligibility, Zt as listAgentsForGateway, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, er as peekSystemEvents, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, qt as loadProviderUsageSummary, s as detectBrowserOpenSupport, un as lookupContextTokens, v as resolveControlUiLinks, x as validateGatewayPasswordInput } from "./loader-CFDxWA8T.js";
...
import { c as resolveStorePath } from "./paths-BZK4Ct0I.js";
import { P as resolveFreshSessionTotalTokens, R as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-udEhG_lJ.js";
import { r as formatDurationPrecise } from "./format-duration--hQihAvf.js";
...
import { r as installCompletion } from "./completion-cli-DNVbKWYJ.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DV9m8zhQ.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-CRQPieXI.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BNvgdkdy.js";
import { o as readLastGatewayErrorLine } from "./service-audit-tpVP1jqw.js";
import { t as renderTable } from "./table-Bvka_vkc.js";
import { o as probeGateway, t as runSecurityAudit } from "./audit-DRmtU2Qf.js";
import { d as applyPrimaryModel, f as promptDefaultModel, g as applyAuthChoice, h as warnIfModelConfigLooksOff, m as resolvePreferredProviderForAuthChoice, r as promptRemoteGatewayConfig, s as promptCustomApiConfig, t as setupSkills, x as promptAuthChoiceGrouped } from "./onboard-skills-BPGCV9QT.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-dUH-zMGm.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-Bnjr5SLD.js";
import { n as logConfigUpdated } from "./logging-B3KnAryz.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BbIz0zmm.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B99Us6yS.js";
import { t as runTui } from "./tui-Chk5TObG.js";
import { t as resolveNodeService } from "./node-service-n1d2hMXt.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-CL8VOhxX.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CBiLPxts.js").then((n) => n.r);
