...
import { X as resolveOAuthPath, Z as resolveStateDir, n as isTruthyEnvValue, o as createSubsystemLogger } from "./entry.js";
import { t as formatCliCommand } from "./command-format-Bxe0mWee.js";
import { n as DEFAULT_AGENT_ID } from "./session-key-DVvxnFKg.js";
import { y as resolveUserPath } from "./utils-BLJAc3ZV.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-DpnW8E9V.js";
import { a as saveJsonFile, i as loadJsonFile, r as resolveCopilotApiToken, t as DEFAULT_COPILOT_API_BASE_URL } from "./github-copilot-token-C9W4SY9o.js";
...
//#endregion
export { buildVeniceModelDefinition as $, modelKey as A, DEFAULT_CONTEXT_TOKENS as At, QIANFAN_BASE_URL as B, resolveOpenClawAgentDir as C, HUGGINGFACE_MODEL_CATALOG as Ct, buildModelAliasIndex as D, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as Dt, buildConfiguredAllowlistKeys as E, isHuggingfacePolicyLocked as Et, resolveConfiguredModelRef as F, CODEX_CLI_PROFILE_ID as Ft, normalizeGoogleModelId as G, XIAOMI_DEFAULT_MODEL_ID as H, resolveDefaultModelForAgent as I, resolveImplicitCopilotProvider as J, normalizeProviders as K, resolveHooksGmailModel as L, parseModelRef as M, DEFAULT_PROVIDER as Mt, resolveAllowedModelRef as N, resolveAuthProfileDisplayLabel as Nt, getModelRefStatus as O, buildCloudflareAiGatewayModelDefinition as Ot, resolveAllowlistModelKey as P, CLAUDE_CLI_PROFILE_ID as Pt, VENICE_MODEL_CATALOG as Q, resolveModelRefFromString as R, resolveAuthStorePathForDisplay as S, HUGGINGFACE_BASE_URL as St, buildAllowedModelSet as T, discoverHuggingfaceModels as Tt, buildQianfanProvider as U, QIANFAN_DEFAULT_MODEL_ID as V, buildXiaomiProvider as W, VENICE_BASE_URL as X, resolveImplicitProviders as Y, VENICE_DEFAULT_MODEL_REF as Z, upsertAuthProfileWithLock as _, getShellPathFromLoginShell as _t, markAuthProfileUsed as a, SYNTHETIC_MODEL_CATALOG as at, updateAuthProfileStoreWithLock as b, shouldDeferShellEnvFallback as bt, CHUTES_AUTHORIZE_ENDPOINT as c, getCustomProviderApiKey as ct, parseOAuthCallbackInput as d, resolveAwsSdkEnvVarName as dt, TOGETHER_BASE_URL as et, repairOAuthProfileIdMismatch as f, resolveEnvApiKey as ft, upsertAuthProfile as g, getShellEnvAppliedKeys as gt, setAuthProfileOrder as h, normalizeSecretInput as ht, markAuthProfileFailure as i, SYNTHETIC_DEFAULT_MODEL_REF as it, normalizeProviderId as j, DEFAULT_MODEL as jt, isCliProvider as k, resolveCloudflareAiGatewayBaseUrl as kt, exchangeChutesCodeForTokens as l, requireApiKey as lt, markAuthProfileGood as m, normalizeOptionalSecretInput as mt, resolveAuthProfileOrder as n, buildTogetherModelDefinition as nt, resolveProfileUnusableUntilForDisplay as o, buildSyntheticModelDefinition as ot, listProfilesForProvider as p, resolveModelAuthMode as pt, resolveImplicitBedrockProvider as q, isProfileInCooldown as r, SYNTHETIC_BASE_URL as rt, resolveApiKeyForProfile as s, getApiKeyForModel as st, auth_profiles_exports as t, TOGETHER_MODEL_CATALOG as tt, generateChutesPkce as u, resolveApiKeyForProvider as ut, ensureAuthProfileStore as v, loadShellEnvFallback as vt, withFileLock as w, buildHuggingfaceModelDefinition as wt, resolveAuthStorePath as x, shouldEnableShellEnvFallback as xt, loadAuthProfileStore as y, resolveShellEnvFallbackTimeoutMs as yt, resolveThinkingDefault as z };