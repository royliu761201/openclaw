import { J as logVerbose, X as shouldLogVerbose, n as runExec } from "./exec-B_drqTKO.js";
import { B as resolveOpenClawAgentDir, b as resolveApiKeyForProvider, f as normalizeGoogleModelId, o as normalizeProviderId, y as requireApiKey } from "./model-selection-Cnk098t1.js";
import { Dn as getFileExtension, Tn as detectMime, Xn as normalizeChatType, jn as kindFromMime, kn as isAudioFileName } from "./pi-embedded-helpers-DjJcmpva.js";
import { t as loadConfig } from "./config-Cq5GKtNh.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BZtw1qk3.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-CiMZofEf.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DluYZdFw.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
