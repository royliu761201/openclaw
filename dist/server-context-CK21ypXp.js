import { G as resolveGatewayPort } from "./entry.js";
import { n as runExec } from "./exec-CPPvAI1K.js";
import { r as isLoopbackHost } from "./ws-MC-rTJLe.js";
import { A as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, D as DEFAULT_BROWSER_EVALUATE_ENABLED, E as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, O as DEFAULT_OPENCLAW_BROWSER_COLOR, S as stopChromeExtensionRelayServer, _ as appendCdpPath, a as resolveOpenClawUserDataDir, h as normalizeCdpWsUrl, i as launchOpenClawChrome, k as DEFAULT_OPENCLAW_BROWSER_ENABLED, n as isChromeCdpReady, o as stopOpenClawChrome, p as createTargetViaCdp, r as isChromeReachable, x as ensureChromeExtensionRelayServer, y as getHeadersWithAuth } from "./chrome-xx1k4_sV.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-Cojm0Kl7.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BV_jBiCD.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BV_jBiCD.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { resolveBrowserConfig as a, allocateColor as c, isValidProfileName as d, deriveDefaultBrowserCdpPortRange as f, parseHttpUrl as i, getUsedColors as l, movePathToTrash as n, resolveProfile as o, getPwAiModule as r, allocateCdpPort as s, createBrowserRouteContext as t, getUsedPorts as u };