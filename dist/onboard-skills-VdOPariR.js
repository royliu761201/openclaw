import { _ as resolveConfigDir, b as resolveUserPath, c as ensureDir, l as escapeRegExp, t as CONFIG_DIR } from "./utils-BtIMES3N.js";
import { Nt as resolveNodeManagerOptions, Ot as openUrl, bt as detectBinary } from "./reply-BJHSzh7M.js";
import { t as runCommandWithTimeout } from "./exec-4V5EwH-r.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-D_p2LOiK.js";
import { $ as discoverHuggingfaceModels, D as VENICE_DEFAULT_MODEL_REF, Et as resolveOpenClawAgentDir, Ft as DEFAULT_PROVIDER, H as resolveEnvApiKey, P as SYNTHETIC_DEFAULT_MODEL_REF, Pt as DEFAULT_MODEL, R as getCustomProviderApiKey, at as resolveAuthProfileOrder, bt as upsertAuthProfileWithLock, d as resolveConfiguredModelRef, dt as CHUTES_AUTHORIZE_ENDPOINT, et as isHuggingfacePolicyLocked, ft as exchangeChutesCodeForTokens, gt as listProfilesForProvider, kt as normalizeSecretInput, mt as parseOAuthCallbackInput, o as modelKey, pt as generateChutesPkce, r as buildModelAliasIndex, s as normalizeProviderId, t as buildAllowedModelSet, tt as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, u as resolveAllowlistModelKey, xt as ensureAuthProfileStore, yt as upsertAuthProfile } from "./model-selection-CTKoRqDI.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { s as loadModelCatalog } from "./runner-DNThkTtX.js";
import { h as hasBinary, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, x as resolveSkillKey } from "./skills-Dz15dAM4.js";
import { a as fetchWithTimeout, r as fetchWithSsrFGuard } from "./fetch-TYcqD9fC.js";
import { t as resolveBrewExecutable } from "./brew-ROHf0-Xp.js";
import { $ as LITELLM_DEFAULT_MODEL_REF, A as applyOpenrouterConfig, At as ZAI_CODING_GLOBAL_BASE_URL, B as applyXaiConfig, C as applyHuggingfaceProviderConfig, Ct as writeOAuthCredentials, D as applyMoonshotConfigCn, Dt as XAI_DEFAULT_MODEL_REF, E as applyMoonshotConfig, Et as QIANFAN_DEFAULT_MODEL_REF, F as applySyntheticProviderConfig, G as applyZaiProviderConfig, H as applyXiaomiConfig, I as applyTogetherConfig, J as applyCloudflareAiGatewayConfig, K as applyLitellmConfig, L as applyTogetherProviderConfig, M as applyQianfanConfig, Mt as buildTokenProfileId, N as applyQianfanProviderConfig, Nt as validateAnthropicSetupToken, O as applyMoonshotProviderConfig, Ot as ZAI_CN_BASE_URL, P as applySyntheticConfig, Q as HUGGINGFACE_DEFAULT_MODEL_REF, R as applyVeniceConfig, St as setZaiApiKey, T as applyKimiCodeProviderConfig, Tt as MOONSHOT_DEFAULT_MODEL_REF, U as applyXiaomiProviderConfig, V as applyXaiProviderConfig, W as applyZaiConfig, X as applyVercelAiGatewayConfig, Y as applyCloudflareAiGatewayProviderConfig, Z as applyVercelAiGatewayProviderConfig, _ as applyMinimaxApiConfig, _t as setTogetherApiKey, at as setAnthropicApiKey, b as applyMinimaxProviderConfig, bt as setXaiApiKey, c as normalizeAlias, ct as setHuggingfaceApiKey, dt as setMinimaxApiKey, et as OPENROUTER_DEFAULT_MODEL_REF, f as createVpsAwareOAuthHandlers, ft as setMoonshotApiKey, g as applyOpencodeZenProviderConfig, gt as setSyntheticApiKey, h as applyOpencodeZenConfig, ht as setQianfanApiKey, i as githubCopilotLoginCommand, it as ZAI_DEFAULT_MODEL_REF, j as applyOpenrouterProviderConfig, jt as ZAI_GLOBAL_BASE_URL, k as applyMoonshotProviderConfigCn, kt as ZAI_CODING_CN_BASE_URL, lt as setKimiCodingApiKey, m as resolvePluginProviders, mt as setOpenrouterApiKey, n as OPENAI_CODEX_DEFAULT_MODEL, nt as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, ot as setCloudflareAiGatewayConfig, p as isRemoteEnvironment, pt as setOpencodeZenApiKey, q as applyLitellmProviderConfig, r as applyOpenAICodexModelDefault, rt as XIAOMI_DEFAULT_MODEL_REF, s as formatTokenK, st as setGeminiApiKey, t as loginOpenAICodexOAuth, tt as TOGETHER_DEFAULT_MODEL_REF, ut as setLitellmApiKey, v as applyMinimaxApiProviderConfig, vt as setVeniceApiKey, w as applyKimiCodeConfig, wt as KIMI_CODING_MODEL_REF, x as applyAuthProfileConfig, xt as setXiaomiApiKey, y as applyMinimaxConfig, yt as setVercelAiGatewayApiKey, z as applyVeniceProviderConfig } from "./openai-codex-oauth-n1IuMNem.js";
import { a as enablePluginInConfig } from "./onboard-channels-DE-boO98.js";
...
import { n as resolveWideAreaDiscoveryDomain } from "./widearea-dns-Ypwgjpsr.js";
...
function applyGoogleGeminiModelDefault(cfg) {
	if (resolvePrimaryModel(cfg.agents?.defaults?.model)?.trim() === GOOGLE_GEMINI_DEFAULT_MODEL) return {
		next: cfg,
		changed: false
	};
	return {
