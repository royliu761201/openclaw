import { D as info, I as colorize, L as isRich, R as theme, c as defaultRuntime, t as createSubsystemLogger } from "./subsystem-DHfJG4gk.js";
import { A as resolveHeartbeatDeliveryTarget, Cr as resolveHeartbeatPrompt$1, Kn as resolveEffectiveMessagesConfig, Mr as peekSystemEvents, Sr as isHeartbeatContentEffectivelyEmpty, _n as resolveIndicatorType, br as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, ct as setHeartbeatWakeHandler, gr as CommandLane, j as resolveHeartbeatSenderContext, mn as emitHeartbeatEvent, pn as resolveHeartbeatVisibility, pr as getQueueSize, qn as resolveUserTimezone, st as requestHeartbeatNow, t as getReplyFromConfig, vn as appendCronStyleCurrentTimeLine, wr as stripHeartbeatToken, xr as DEFAULT_HEARTBEAT_EVERY } from "./reply-BJHSzh7M.js";
...
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-D_p2LOiK.js";
import { t as isTruthyEnvValue } from "./env-BUuSkE19.js";
import { g as parseDurationMs, i as loadConfig } from "./config-CmDYseI1.js";
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-BvNdouUY.js";
import { I as canonicalizeMainSessionAlias, L as resolveAgentMainSessionKey, d as loadSessionStore, g as updateSessionStore, m as saveSessionStore } from "./sandbox-4W8S1yx4.js";
import { n as formatErrorMessage } from "./errors-Bv81hF2P.js";
import { c as resolveStorePath } from "./paths-DdKf4lHp.js";
import { q as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-Btwgh8AF.js";
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fs$1.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason && !isCronEventReason) {
			emitHeartbeatEvent({
				status: "skipped",
