import { l as createSubsystemLogger, t as runCommandWithTimeout, w as CONFIG_DIR } from "./exec-C8pFr4y3.js";
import { t as formatCliCommand } from "./command-format-qUVxzqYm.js";
import { i as isErrno } from "./errors-B91HIDPD.js";
...
async function canExecute(path) {
	try {
		await fs.access(path, fs$1.constants.X_OK);
		return true;
	} catch {
		return false;
	}
