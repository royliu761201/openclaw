import { A as theme, G as resolveGatewayPort, O as colorize, V as resolveConfigPath, Y as resolveOAuthDir, Z as resolveStateDir, a as parseBooleanValue, ct as normalizeChatChannelId, f as visibleWidth, it as getChatChannelMeta, k as isRich, m as restoreTerminalState, p as defaultRuntime, tt as DEFAULT_CHAT_CHANNEL, v as danger, w as setVerbose, y as info, z as isNixMode } from "./entry.js";
import { At as DEFAULT_CONTEXT_TOKENS, F as resolveConfiguredModelRef, Mt as DEFAULT_PROVIDER, ft as resolveEnvApiKey, g as upsertAuthProfile, ht as normalizeSecretInput, j as normalizeProviderId, jt as DEFAULT_MODEL, mt as normalizeOptionalSecretInput, n as resolveAuthProfileOrder, s as resolveApiKeyForProfile, v as ensureAuthProfileStore, x as resolveAuthStorePath } from "./auth-profiles-DIgZUMSR.js";
...
import { S as shortenHomePath, _ as resolveHomeDir, x as shortenHomeInString, y as resolveUserPath } from "./utils-BLJAc3ZV.js";
import { t as runCommandWithTimeout } from "./exec-CPPvAI1K.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-DpnW8E9V.js";
import { c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BDCbZ1IN.js";
import { n as movePathToTrash } from "./server-context-CK21ypXp.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-VglkjpoM.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-DWcu72r7.js";
import { t as formatDocsLink } from "./links-DpxpaKe1.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-haUgxMzs.js";
import { Cn as CHANNEL_MESSAGE_ACTION_NAMES, D as registerMemoryCli, Kn as CHANNEL_TARGETS_DESCRIPTION, O as runMemoryStatus, S as waitForGatewayReachable, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, f as moveToTrash, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, ln as resolveCommitHash, m as openUrl, pn as runMessageAction, qn as CHANNEL_TARGET_DESCRIPTION, s as detectBrowserOpenSupport, un as lookupContextTokens, v as resolveControlUiLinks, xn as formatTargetDisplay } from "./loader-CbLFPWQb.js";
import { n as withProgress } from "./progress-COHv-uNT.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Cf1r1L6k.js";
import { t as WizardCancelledError } from "./prompts-Dszjy1n_.js";
import { t as createClackPrompter } from "./clack-prompter-DpuKn_Uy.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-ByYj2Aq5.js";
import { n as setupChannels } from "./onboard-channels-OrFKfq-E.js";
import { c as resolveStorePath, o as resolveSessionTranscriptsDir, s as resolveSessionTranscriptsDirForAgent } from "./paths-BZK4Ct0I.js";
import { P as resolveFreshSessionTotalTokens, d as loadSessionStore } from "./sandbox-BdqugcyI.js";
import { n as formatTimeAgo } from "./format-relative-Cywx6ldk.js";
import { n as runCommandWithRuntime } from "./cli-utils-CodyYLHe.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-C7IBfuQY.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-C6HFPvZP.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CUVSCDJV.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-2vsLL9Ek.js";
import { t as createDefaultDeps } from "./deps-45EpC_d1.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CQtpMCvD.js";
import { t as resolveGatewayService } from "./service-CRQPieXI.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BNvgdkdy.js";
import { t as renderTable } from "./table-Bvka_vkc.js";
import { _ as applyOpenAIConfig, a as applyCustomApiConfig, b as applyGoogleGeminiModelDefault, c as resolveCustomProviderId, g as applyAuthChoice, h as warnIfModelConfigLooksOff, i as CustomApiError, o as parseNonInteractiveCustomApiFlags, v as upsertSharedEnvVar, x as promptAuthChoiceGrouped, y as detectZaiEndpoint } from "./onboard-skills-SfYIvc4_.js";
import { l as healthCommand } from "./health-format-B6GzNQyP.js";
import { A as applyOpenrouterConfig, B as applyXaiConfig, D as applyMoonshotConfigCn, E as applyMoonshotConfig, H as applyXiaomiConfig, I as applyTogetherConfig, J as applyCloudflareAiGatewayConfig, K as applyLitellmConfig, M as applyQianfanConfig, Mt as buildTokenProfileId, Nt as validateAnthropicSetupToken, P as applySyntheticConfig, R as applyVeniceConfig, S as applyHuggingfaceConfig, St as setZaiApiKey, W as applyZaiConfig, X as applyVercelAiGatewayConfig, _ as applyMinimaxApiConfig, _t as setTogetherApiKey, at as setAnthropicApiKey, bt as setXaiApiKey, ct as setHuggingfaceApiKey, dt as setMinimaxApiKey, ft as setMoonshotApiKey, gt as setSyntheticApiKey, h as applyOpencodeZenConfig, ht as setQianfanApiKey, lt as setKimiCodingApiKey, mt as setOpenrouterApiKey, ot as setCloudflareAiGatewayConfig, pt as setOpencodeZenApiKey, st as setGeminiApiKey, ut as setLitellmApiKey, vt as setVeniceApiKey, w as applyKimiCodeConfig, x as applyAuthProfileConfig, xt as setXiaomiApiKey, y as applyMinimaxConfig, yt as setVercelAiGatewayApiKey } from "./openai-codex-oauth-CB1gd8yk.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-B3KnAryz.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-K81lvqOS.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BTltSA4o.js";
import { t as formatHelpExamples } from "./help-format-Cd5PLwXe.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-CiOxmwmq.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CBiLPxts.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-iuGnz6pb.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-CiOxmwmq.js").then((n) => n.t);
