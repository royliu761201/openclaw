import { Y as logVerbose, Z as shouldLogVerbose, n as runExec } from "./exec-C8pFr4y3.js";
import { Dn as detectMime, Nn as kindFromMime, Qn as normalizeChatType, jn as isAudioFileName, kn as getFileExtension } from "./pi-embedded-helpers-ByNs1l2C.js";
import { A as normalizeGoogleModelId, _ as resolveOpenClawAgentDir, i as resolveApiKeyForProvider, r as requireApiKey, w as normalizeProviderId } from "./model-auth-SqbPPe-9.js";
import { t as loadConfig } from "./config-BS1q86jE.js";
import { b as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-BQvYe7_a.js";
import { a as fetchWithTimeout, n as fetchRemoteMedia, r as fetchWithSsrFGuard, t as MediaFetchError } from "./fetch-xb_5Td_b.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-DqgqUyAv.js").then((n) => n.r);
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-Bjmwdg16.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
