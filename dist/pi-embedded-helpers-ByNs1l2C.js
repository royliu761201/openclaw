...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DevPQTaM.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DevPQTaM.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { updateSessionStore as $, listEnabledDiscordAccounts as $n, resolveSandboxedMediaSource as $t, isBillingAssistantError as A, imageMimeFromFormat as An, registerBrowserRoutes as At, isTransientHttpError as B, listChannelPlugins as Bn, SsrFBlockedError as Bt, BILLING_ERROR_USER_MESSAGE as C, resolveMessageChannel as Cn, resolveIMessageAccount as Ct, formatRawAssistantErrorForUi as D, detectMime as Dn, resolveConversationLabel as Dt, formatBillingErrorMessage as E, GATEWAY_CLIENT_NAMES as En, resolveChannelGroupToolsPolicy as Et, isFailoverErrorMessage as F, maxBytesForKind as Fn, hasAlphaChannel as Ft, resolveSandboxContext as G, listTelegramAccountIds as Gn, resolvePinnedHostnameWithPolicy as Gt, parseImageSizeError as H, isWhatsAppGroupJid as Hn, createPinnedDispatcher as Ht, isLikelyContextOverflowError as I, mediaKindFromMime as In, optimizeImageToPng as It, resolveMirroredTranscriptText as J, listBindings as Jn, loadWorkspaceSkillEntries as Jt, resolveSandboxRuntimeStatus as K, resolveTelegramAccount as Kn, buildWorkspaceSkillCommandSpecs as Kt, isRateLimitAssistantError as L, listEnabledSignalAccounts as Ln, resizeToJpeg as Lt, isCompactionFailureError as M, isGifMedia as Mn, resolveProfile as Mt, isContextOverflowError as N, kindFromMime as Nn, convertHeicToJpeg as Nt, getApiErrorPayloadFingerprint as O, extensionForMime as On, resolveGroupSessionKey as Ot, isFailoverAssistantError as P, MAX_IMAGE_BYTES$1 as Pn, getImageMetadata as Pt, updateLastRoute as Q, normalizeChatType as Qn, assertSandboxPath as Qt, isRawApiErrorPayload as R, resolveSignalAccount as Rn, getMediaDir as Rt, isGoogleModelApi as S, resolveGatewayMessageChannel as Sn, listChannelDocks as St, formatAssistantErrorText as T, GATEWAY_CLIENT_MODES as Tn, resolveChannelGroupRequireMention as Tt, sanitizeUserFacingText as U, normalizeWhatsAppTarget as Un, isBlockedHostname as Ut, parseImageDimensionError as V, normalizeChannelId as Vn, closeDispatcher as Vt, ensureSandboxWorkspaceForSession as W, listEnabledTelegramAccounts as Wn, isPrivateIpAddress as Wt, readSessionUpdatedAt as X, resolveSlackAppToken as Xn, resolvePluginSkillDirs as Xt, loadSessionStore as Y, resolveSlackAccount as Yn, resolveSkillsPromptForRun as Yt, recordSessionMetaFromInbound as Z, resolveSlackBotToken as Zn, assertMediaNotDataUrl as Zt, sanitizeSessionMessagesImages as _, isGatewayMessageChannel as _n, resolveFreshSessionTotalTokens as _t, formatXHighModelHint as a, collectExplicitAllowlist as an, mergeDeliveryContext as at, downgradeOpenAIReasoningBlocks as b, listDeliverableMessageChannels as bn, deriveSessionMetaPatch as bt, normalizeReasoningLevel as c, normalizeToolName as cn, normalizeAccountId as ct, normalizeVerboseLevel as d, buildBootstrapContextFiles as dn, evaluateSessionFreshness as dt, applySkillEnvOverrides as en, resolveDiscordAccount as er, updateSessionStoreEntry as et, resolveResponseUsageMode as f, ensureSessionHeader$1 as fn, resolveChannelResetConfig as ft, normalizeTextForComparison as g, isDeliverableMessageChannel as gn, DEFAULT_RESET_TRIGGERS as gt, isMessagingToolDuplicateNormalized as h, INTERNAL_MESSAGE_CHANNEL as hn, resolveThreadFlag as ht, formatThinkingLevels as i, buildPluginToolGroups as in, deliveryContextKey as it, isCloudCodeAssistFormatError as j, isAudioFileName as jn, resolveBrowserConfig as jt, isAuthAssistantError as k, getFileExtension as kn, createBrowserRouteContext as kt, normalizeThinkLevel as l, resolveToolProfilePolicy as ln, acquireSessionWriteLock as lt, isMessagingToolDuplicate as m, sanitizeGoogleTurnOrdering as mn, resolveSessionResetType as mt, validateGeminiTurns as n, resolveSandboxConfigForAgent as nn, resolveCacheTtlMs as nt, listThinkingLevels as o, expandPolicyWithPluginGroups as on, normalizeDeliveryContext as ot, supportsXHighThinking as p, resolveBootstrapMaxChars as pn, resolveSessionResetPolicy as pt, appendAssistantMessageToSessionTranscript as q, resolveTelegramToken as qn, buildWorkspaceSkillSnapshot as qt, pickFallbackThinkingLevel as r, applyOwnerOnlyToolPolicy as rn, deliveryContextFromSession as rt, normalizeElevatedLevel as s, expandToolGroups as sn, normalizeSessionDeliveryFields as st, validateAnthropicTurns as t, applySkillEnvOverridesFromSnapshot as tn, normalizeDiscordToken as tr, isCacheEnabled as tt, normalizeUsageDisplay as u, stripPluginOnlyAllowlist as un, resolveSessionKey as ut, sanitizeImageBlocks as v, isInternalMessageChannel as vn, resolveExplicitAgentSessionKey as vt, classifyFailoverReason as w, GATEWAY_CLIENT_IDS as wn, resolveChannelGroupPolicy as wt, isAntigravityClaude as x, normalizeMessageChannel as xn, getChannelDock as xt, sanitizeToolResultImages as y, isMarkdownCapableMessageChannel as yn, resolveMainSessionKey as yt, isTimeoutErrorMessage as z, getChannelPlugin as zn, saveMediaBuffer as zt };