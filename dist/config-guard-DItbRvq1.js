...
import { c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-TOMBPbi7.js";
import { n as movePathToTrash } from "./server-context-CK21ypXp.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-DHpd82Uy.js";
...
import { n as setupChannels } from "./onboard-channels-DizOwdL0.js";
...
import { P as resolveFreshSessionTotalTokens, d as loadSessionStore } from "./sandbox-udEhG_lJ.js";
import { n as formatTimeAgo } from "./format-relative-Cywx6ldk.js";
import { n as runCommandWithRuntime } from "./cli-utils-CodyYLHe.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-Bbt4zcNn.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-CiLQGJuX.js";
...
import { t as createDefaultDeps } from "./deps-DRcCHM3p.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DV9m8zhQ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-BDb6zkLM.js").then((n) => n.t);
