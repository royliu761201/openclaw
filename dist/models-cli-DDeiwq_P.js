...
import { I as colorize, L as isRich$1, R as theme, c as defaultRuntime } from "./subsystem-DHfJG4gk.js";
import { C as shortenHomePath } from "./utils-BtIMES3N.js";
import "./pi-embedded-helpers-BubZUNx-.js";
import { Ot as openUrl, R as describeFailoverError, dr as resolveModel, dt as loadProviderUsageSummary, l as runEmbeddedPiAgent, mt as resolveUsageProviderId, pt as formatUsageWindowSummary } from "./reply-BJHSzh7M.js";
import "./exec-4V5EwH-r.js";
import { a as resolveAgentModelPrimary, c as resolveDefaultAgentId, i as resolveAgentModelFallbacksOverride, r as resolveAgentDir, s as resolveAgentWorkspaceDir, w as resolveDefaultAgentWorkspaceDir } from "./agent-scope-D_p2LOiK.js";
import { At as resolveAuthProfileDisplayLabel, B as resolveApiKeyForProvider, Et as resolveOpenClawAgentDir, Ft as DEFAULT_PROVIDER, H as resolveEnvApiKey, Pt as DEFAULT_MODEL, R as getCustomProviderApiKey, Tt as resolveAuthStorePathForDisplay, V as resolveAwsSdkEnvVarName, W as getShellEnvAppliedKeys, Y as shouldEnableShellEnvFallback, at as resolveAuthProfileOrder, c as parseModelRef, d as resolveConfiguredModelRef, f as resolveDefaultModelForAgent, gt as listProfilesForProvider, lt as resolveProfileUnusableUntilForDisplay, m as resolveModelRefFromString, o as modelKey, r as buildModelAliasIndex, s as normalizeProviderId, vt as setAuthProfileOrder, xt as ensureAuthProfileStore, yt as upsertAuthProfile } from "./model-selection-CTKoRqDI.js";
import "./github-copilot-token-CiF5Iyi2.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import "./boolean-BgXe2hyu.js";
import "./env-BUuSkE19.js";
import { g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-CmDYseI1.js";
...
import { v as ensureOpenClawModelsJson } from "./image-BFquFRGY.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-DdKf4lHp.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-CRhVAaLV.js";
import { r as withProgressTotals } from "./progress-DZb6yPcJ.js";
...
import { Nt as validateAnthropicSetupToken, a as ensureFlagCompatibility, c as normalizeAlias, d as updateConfig, f as createVpsAwareOAuthHandlers, i as githubCopilotLoginCommand, l as resolveKnownAgentId, m as resolvePluginProviders, n as OPENAI_CODEX_DEFAULT_MODEL, o as formatMs, p as isRemoteEnvironment, s as formatTokenK, t as loginOpenAICodexOAuth, u as resolveModelTarget, x as applyAuthProfileConfig } from "./openai-codex-oauth-n1IuMNem.js";
import { t as renderTable } from "./table-BIk8Aan_.js";
import { n as redactSecrets } from "./format-DcfK-dwd.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CTTtVxra.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./system-cli-8-fZeC9G.js";
...
async function modelsAuthLoginCommand(opts, runtime) {
	...
	if ((opts.provider ? normalizeProviderId(opts.provider) : null) === "openai-codex") {
		const method = opts.method?.trim().toLowerCase();
		if (method && method !== "oauth") throw new Error("OpenAI Codex auth only supports --method \"oauth\".");
		...
		await updateConfig((cfg) => {
			...
			if (opts.setDefault) next = applyDefaultModel(next, OPENAI_CODEX_DEFAULT_MODEL);
			return next;
		});
		logConfigUpdated(runtime);
		runtime.log(`Auth profile: ${profileId} (openai-codex/oauth)`);
		runtime.log(opts.setDefault ? `Default model set to ${OPENAI_CODEX_DEFAULT_MODEL}` : `Default model available: ${OPENAI_CODEX_DEFAULT_MODEL} (use --set-default to apply)`);
		return;
	}
...
async function modelsListCommand(opts, runtime) {
	...
	if (opts.all) {
		...
		if (!model) {
			const resolved = resolveModel(entry.ref.provider, entry.ref.model, void 0, cfg);
			if (resolved.model && !resolved.error) model = resolved.model;
		}
