...
import { $ as CHANNEL_IDS, B as resolveCanonicalConfigPath, G as resolveGatewayPort, H as resolveConfigPathCandidate, I as CONFIG_PATH, J as resolveNewStateDir, K as resolveIsNixMode, L as DEFAULT_GATEWAY_PORT, R as STATE_DIR, U as resolveDefaultConfigCandidates, V as resolveConfigPath, W as resolveGatewayLockDir, X as resolveOAuthPath, Y as resolveOAuthDir, Z as resolveStateDir, ct as normalizeChatChannelId, ht as resolveRequiredHomeDir, q as resolveLegacyStateDirs, z as isNixMode } from "./entry.js";
import { At as DEFAULT_CONTEXT_TOKENS, M as parseModelRef, bt as shouldDeferShellEnvFallback, vt as loadShellEnvFallback, xt as shouldEnableShellEnvFallback, yt as resolveShellEnvFallbackTimeoutMs } from "./auth-profiles-DIgZUMSR.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID } from "./session-key-DVvxnFKg.js";
import { d as isRecord, g as resolveConfigDir, u as isPlainObject$1, y as resolveUserPath } from "./utils-BLJAc3ZV.js";
import { c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-DpnW8E9V.js";
import { d as resolveMemorySlotDecision, l as normalizePluginsConfig, t as loadPluginManifestRegistry, u as resolveEnableState } from "./manifest-registry-CVsqjgX0.js";
...
function createConfigIO(overrides = {}) {
	...
	async function writeConfigFile(cfg) {
		...
		const outputConfig = envRefMap && changedPaths ? restoreEnvRefsFromMap(validated.config, "", envRefMap, changedPaths) : validated.config;
...
//#endregion
export { MAX_INCLUDE_DEPTH as A, parseConfigPath as C, applyLegacyMigrations as D, applyMergePatch as E, loadDotEnv as F, resolveAgentMaxConcurrent as M, resolveSubagentMaxConcurrent as N, isSafeExecutableValue as O, VERSION as P, getConfigValueAtPath as S, unsetConfigValueAtPath as T, validateJsonSchemaValue as _, parseConfigJson5 as a, setConfigOverride as b, writeConfigFile as c, parseByteSize as d, TELEGRAM_COMMAND_NAME_PATTERN as f, parseDurationMs as g, sensitive as h, loadConfig as i, collectConfigEnvVars as j, INCLUDE_KEY as k, validateConfigObjectWithPlugins as l, resolveTelegramCustomCommands as m, migrateLegacyConfig as n, readConfigFileSnapshot as o, normalizeTelegramCommandName as p, createConfigIO as r, resolveConfigSnapshotHash as s, config_exports as t, OpenClawSchema as u, getConfigOverrides as v, setConfigValueAtPath as w, unsetConfigOverride as x, resetConfigOverrides as y };