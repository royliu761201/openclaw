import { c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL } from "./subsystem-DHfJG4gk.js";
import { J as supportsXHighThinking, K as normalizeVerboseLevel, R as formatThinkingLevels, W as normalizeThinkLevel, z as formatXHighModelHint } from "./pi-embedded-helpers-BubZUNx-.js";
import { Dr as applyModelOverrideToSessionEntry, Er as clearSessionAuthProfileOverride, Kr as resolveAgentTimeoutMs, L as runWithModelFallback, Ln as registerAgentRunContext, M as resolveOutboundTarget, Mn as AGENT_LANE_NESTED, N as resolveSessionDeliveryTarget, Nn as clearAgentRunContext, Or as applyVerboseOverride, Pn as emitAgentEvent, Tr as lookupContextTokens, Vt as getRemoteSkillEligibility, en as getSkillsSnapshotVersion, i as runCliAgent, l as runEmbeddedPiAgent, n as getCliSessionId, r as setCliSessionId, s as resolveSendPolicy } from "./reply-BJHSzh7M.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary, i as resolveAgentModelFallbacksOverride, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, x as ensureAgentWorkspace } from "./agent-scope-D_p2LOiK.js";
import { Ft as DEFAULT_PROVIDER, Nt as DEFAULT_CONTEXT_TOKENS, Pt as DEFAULT_MODEL, a as isCliProvider, d as resolveConfiguredModelRef, h as resolveThinkingDefault, o as modelKey, t as buildAllowedModelSet, xt as ensureAuthProfileStore } from "./model-selection-CTKoRqDI.js";
import { t as formatCliCommand } from "./command-format-ChfKqObn.js";
import { i as loadConfig } from "./config-CmDYseI1.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-BvNdouUY.js";
import { A as resolveChannelResetConfig, M as resolveSessionResetType, O as resolveSessionKey, R as resolveExplicitAgentSessionKey, T as normalizeAccountId, d as loadSessionStore, g as updateSessionStore, j as resolveSessionResetPolicy, k as evaluateSessionFreshness } from "./sandbox-4W8S1yx4.js";
import { s as loadModelCatalog } from "./runner-DNThkTtX.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-Dz15dAM4.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CTtrEkmW.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-DdKf4lHp.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-Btwgh8AF.js";
import { l as deriveSessionTotalTokens, u as hasNonzeroUsage } from "./session-cost-usage-BYUb7fov.js";
