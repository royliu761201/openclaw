...
import { b as resolveUserPath } from "./utils-BtIMES3N.js";
import { n as DEFAULT_AGENT_ID } from "./session-key-BWxPj0z_.js";
import { a as resolveAgentModelPrimary } from "./agent-scope-D_p2LOiK.js";
...
//#endregion
export { discoverHuggingfaceModels as $, TOGETHER_BASE_URL as A, resolveAuthProfileDisplayLabel as At, resolveApiKeyForProvider as B, resolveImplicitBedrockProvider as C, updateAuthProfileStoreWithLock as Ct, VENICE_DEFAULT_MODEL_REF as D, withFileLock as Dt, VENICE_BASE_URL as E, resolveOpenClawAgentDir as Et, SYNTHETIC_MODEL_CATALOG as F, DEFAULT_PROVIDER as Ft, getShellPathFromLoginShell as G, resolveEnvApiKey as H, buildSyntheticModelDefinition as I, shouldDeferShellEnvFallback as J, loadShellEnvFallback as K, getApiKeyForModel as L, buildTogetherModelDefinition as M, CODEX_CLI_PROFILE_ID as Mt, SYNTHETIC_BASE_URL as N, DEFAULT_CONTEXT_TOKENS as Nt, VENICE_MODEL_CATALOG as O, normalizeOptionalSecretInput as Ot, SYNTHETIC_DEFAULT_MODEL_REF as P, DEFAULT_MODEL as Pt, buildHuggingfaceModelDefinition as Q, getCustomProviderApiKey as R, normalizeProviders as S, loadAuthProfileStore as St, resolveImplicitProviders as T, resolveAuthStorePathForDisplay as Tt, resolveModelAuthMode as U, resolveAwsSdkEnvVarName as V, getShellEnvAppliedKeys as W, HUGGINGFACE_BASE_URL as X, shouldEnableShellEnvFallback as Y, HUGGINGFACE_MODEL_CATALOG as Z, QIANFAN_DEFAULT_MODEL_ID as _, markAuthProfileGood as _t, isCliProvider as a, resolveAuthProfileOrder as at, buildXiaomiProvider as b, upsertAuthProfileWithLock as bt, parseModelRef as c, markAuthProfileUsed as ct, resolveConfiguredModelRef as d, CHUTES_AUTHORIZE_ENDPOINT as dt, isHuggingfacePolicyLocked as et, resolveDefaultModelForAgent as f, exchangeChutesCodeForTokens as ft, QIANFAN_BASE_URL as g, listProfilesForProvider as gt, resolveThinkingDefault as h, repairOAuthProfileIdMismatch as ht, getModelRefStatus as i, auth_profiles_exports as it, TOGETHER_MODEL_CATALOG as j, CLAUDE_CLI_PROFILE_ID as jt, buildVeniceModelDefinition as k, normalizeSecretInput as kt, resolveAllowedModelRef as l, resolveProfileUnusableUntilForDisplay as lt, resolveModelRefFromString as m, parseOAuthCallbackInput as mt, buildConfiguredAllowlistKeys as n, buildCloudflareAiGatewayModelDefinition as nt, modelKey as o, isProfileInCooldown as ot, resolveHooksGmailModel as p, generateChutesPkce as pt, resolveShellEnvFallbackTimeoutMs as q, buildModelAliasIndex as r, resolveCloudflareAiGatewayBaseUrl as rt, normalizeProviderId as s, markAuthProfileFailure as st, buildAllowedModelSet as t, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as tt, resolveAllowlistModelKey as u, resolveApiKeyForProfile as ut, XIAOMI_DEFAULT_MODEL_ID as v, setAuthProfileOrder as vt, resolveImplicitCopilotProvider as w, resolveAuthStorePath as wt, normalizeGoogleModelId as x, ensureAuthProfileStore as xt, buildQianfanProvider as y, upsertAuthProfile as yt, requireApiKey as z };