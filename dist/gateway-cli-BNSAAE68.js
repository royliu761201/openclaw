...
import { B as getLogger, C as getActivePluginRegistry, I as colorize, L as isRich, M as setVerbose, R as theme, V as getResolvedLoggerSettings, a as setConsoleTimestampPrefix, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, i as setConsoleSubsystemFilter, n as runtimeForLogger, p as CHANNEL_IDS, t as createSubsystemLogger, z as getChildLogger } from "./subsystem-DHfJG4gk.js";
import { C as shortenHomePath, D as truncateUtf16Safe, b as resolveUserPath, c as ensureDir, d as isPlainObject, r as clamp, t as CONFIG_DIR } from "./utils-BtIMES3N.js";
import { G as normalizeUsageDisplay, H as normalizeElevatedLevel, J as supportsXHighThinking, K as normalizeVerboseLevel, R as formatThinkingLevels, U as normalizeReasoningLevel, W as normalizeThinkLevel, z as formatXHighModelHint } from "./pi-embedded-helpers-BubZUNx-.js";
import { $ as inferLegacyName, $n as OPENAI_TTS_VOICES, $t as verifyNodeToken, An as initSubagentRegistry, Ar as enqueueSystemEvent, B as consumeGatewaySigusr1RestartAuthorization, Br as DEFAULT_INPUT_PDF_MAX_PIXELS, Bt as resolveAssistantAvatarUrl, C as readSessionMessages, Dn as formatZonedTimestamp, Dr as applyModelOverrideToSessionEntry, E as stripEnvelopeFromMessages, En as createReplyDispatcher, F as resetDirectoryCache, Fn as getAgentRunContext, Fr as DEFAULT_INPUT_FILE_MIMES, G as formatDoctorNonInteractiveHint, Gn as resolveAgentIdentity, Gr as normalizeMimeList, Gt as refreshRemoteNodeBins, H as scheduleGatewaySigusr1Restart, Hn as ToolInputError, Hr as DEFAULT_INPUT_TIMEOUT_MS, Ht as primeRemoteSkillsCache, In as onAgentEvent, Ir as DEFAULT_INPUT_IMAGE_MAX_BYTES, J as summarizeRestartSentinel, Jn as clearInternalHooks, Jt as listNodePairing, K as formatRestartSentinelMessage, Kr as resolveAgentTimeoutMs, Kt as setSkillsRemoteRegistry, L as runWithModelFallback, Ln as registerAgentRunContext, Lr as DEFAULT_INPUT_IMAGE_MIMES, Lt as CONTROL_UI_AVATAR_PREFIX, M as resolveOutboundTarget, N as resolveSessionDeliveryTarget, Nn as clearAgentRunContext, Nr as DEFAULT_INPUT_FILE_MAX_BYTES, O as ensureOutboundSessionEntry, On as isAbortTrigger, Or as applyVerboseOverride, Pn as emitAgentEvent, Pr as DEFAULT_INPUT_FILE_MAX_CHARS, Q as normalizeCronJobPatch, Qn as OPENAI_TTS_MODELS, Qt as updatePairedNodeMetadata, Rr as DEFAULT_INPUT_MAX_REDIRECTS, Rt as buildControlUiAvatarUrl, S as capArrayByJsonBytes, Sn as getChannelActivity, T as resolveSessionTranscriptCandidates, Tn as dispatchInboundMessage, Tr as lookupContextTokens, Tt as handleReset, U as setGatewaySigusr1RestartPolicy, Un as getMemorySearchManager, Ur as extractFileContentFromSource, Ut as recordRemoteNodeInfo, V as isGatewaySigusr1RestartExternallyAllowed, Vr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Vt as getRemoteSkillEligibility, W as consumeRestartSentinel, Wn as resolveMemoryBackendConfig, Wr as extractImageContentFromSource, Wt as refreshRemoteBinsForConnectedNodes, X as writeRestartSentinel, Xn as registerInternalHook, Xt as renamePairedNode, Yn as createInternalHookEvent, Yt as rejectNodePairing, Z as normalizeCronJobCreate, Zn as triggerInternalHook, Zt as requestNodePairing, _ as loadCombinedSessionStoreForGateway, _r as startDiagnosticHeartbeat, an as isExternalHookSession, ar as resolveTtsConfig, b as resolveSessionModelRef, br as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, c as clearSessionQueues, cr as setTtsEnabled, d as waitForEmbeddedPiRunEnd, dt as loadProviderUsageSummary, en as getSkillsSnapshotVersion, er as getTtsProvider, et as normalizeOptionalAgentId, fn as buildHistoryContextFromEntries, fr as getActiveTaskCount, g as listSessionsFromStore, gn as onHeartbeatEvent, gr as CommandLane, gt as handleSlackHttpRequest, h as listAgentsForGateway, hn as getLastHeartbeatEvent, hr as waitForActiveTasks, i as runCliAgent, in as getHookType, ir as resolveTtsAutoMode, it as migrateLegacyCronPayload, jn as runSubagentAnnounceFlow, jr as isSystemEventContextChanged, k as resolveOutboundSessionRoute, kn as stopSubagentsForRequester, kr as parseVerboseOverride, l as runEmbeddedPiAgent, ln as createReplyPrefixOptions, lr as setTtsProvider, lt as getPluginToolMeta, m as resolveAnnounceTargetFromKey, mr as setCommandLaneConcurrency, n as getCliSessionId, nn as buildSafeExternalPrompt, nr as isTtsProviderConfigured, nt as normalizePayloadToSystemText, o as normalizeSendPolicy, or as resolveTtsPrefsPath, p as createOpenClawTools, pn as resolveHeartbeatVisibility, qn as resolveUserTimezone, qt as approveNodePairing, r as setCliSessionId, rn as detectSuspiciousPatterns, rr as resolveTtsApiKey, rt as normalizeRequiredName, s as resolveSendPolicy, sr as resolveTtsProviderOrder, st as requestHeartbeatNow, tn as registerSkillsChangeListener, tr as isTtsEnabled, tt as normalizeOptionalText, u as abortEmbeddedPiRun, un as normalizeGroupActivation, ur as textToSpeech, ut as loadOpenClawPlugins, v as loadSessionEntry, vr as stopDiagnosticHeartbeat, w as readSessionPreviewItemsFromTranscript, wr as stripHeartbeatToken, x as archiveFileOnDisk, y as resolveGatewaySessionStoreTarget, yn as resolveCronStyleNow, yr as isDiagnosticsEnabled, z as authorizeGatewaySigusr1Restart, zn as normalizePollInput, zr as DEFAULT_INPUT_PDF_MAX_PAGES, zt as normalizeControlUiBasePath } from "./reply-BJHSzh7M.js";
...
import { n as withProgress } from "./progress-DZb6yPcJ.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-BFjunfHK.js";
import "./prompt-style-lSlXMhsd.js";
import "./pairing-labels-XkKxEWhj.js";
import { i as loadSessionUsageTimeSeries, l as deriveSessionTotalTokens, n as loadCostUsageSummary, r as loadSessionCostSummary, t as discoverAllSessions, u as hasNonzeroUsage } from "./session-cost-usage-BYUb7fov.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-CpORtVCG.js";
import { c as normalizeExecApprovals, g as saveExecApprovals, l as readExecApprovalsSnapshot, m as resolveExecApprovalsSocketPath, r as ensureExecApprovals } from "./exec-approvals-Bqk-tIxY.js";
import "./nodes-screen-DsHJIN2I.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, c as safeEqualSecret, d as enableTailscaleFunnel, f as enableTailscaleServe, i as resolveGatewayAuth, l as disableTailscaleFunnel, m as getTailnetHostname, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured, u as disableTailscaleServe } from "./auth-DWxmgKrO.js";
import "./control-auth-C4WYidv4.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-DbHg7sY9.js";
import { t as parseAbsoluteTimeMs } from "./parse-Bw0oH-rT.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-C3umWMS0.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BkKXWFia.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BRKerjt1.js";
import "./daemon-runtime-DNkQBUkt.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, i as applyAgentConfig, l as pruneAgentConfig, o as findAgentEntryIndex, p as forceFreePortAndWait, r as getStatusSummary, s as listAgentEntries, t as runOnboardingWizard } from "./onboarding-pbjVZbQ4.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-HyeZXsnu.js";
import "./logging-DEPo2hji.js";
import "./note-uC6iDp4y.js";
import { t as WizardCancelledError } from "./prompts-Bg96reub.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-VdOPariR.js";
import "./openai-codex-oauth-n1IuMNem.js";
import "./onboard-channels-DE-boO98.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-DGk4w37p.js";
import "./archive-beaSfAzA.js";
import "./skill-scanner-CucvxYhu.js";
import "./installs-DsIhz365.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-BZ_Q7GD8.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-DeCtsPt9.js";
import { a as resolveNodeCommandAllowlist, i as isNodeCommandAllowed, o as probeGateway } from "./audit-M_67MoOZ.js";
import "./table-BIk8Aan_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-ChM7JE47.js";
import "./service-6LexomJs.js";
import "./systemd-4esm7UkF.js";
import "./service-audit-D72EQIK3.js";
import "./node-service-BMIEJX3_.js";
import "./channels-status-issues-Cs9Skq7X.js";
import "./completion-cli-DzEDn1_H.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-BNS7Iuc_.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-Ypwgjpsr.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-DPJORMB6.js";
import "./tui-DRh73jR5.js";
import { t as buildChannelAccountSnapshot } from "./status-C_dMhoE0.js";
import "./shared-CK5CwFGt.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-Ds9XOSSz.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-BvTLT_H0.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-lip4ETlm.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-Sp5tbmD8.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-dCvmlHnF.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-BYUb7fov.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DbHg7sY9.js").then((n) => n.t);
