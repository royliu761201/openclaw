...
import { D as info, E as danger, I as colorize, L as isRich, M as setVerbose, R as theme, S as normalizeChatChannelId, c as defaultRuntime, h as DEFAULT_CHAT_CHANNEL, l as restoreTerminalState, r as enableConsoleCapture, s as visibleWidth, v as getChatChannelMeta } from "./subsystem-DHfJG4gk.js";
import { C as shortenHomePath, E as toWhatsappJid, S as shortenHomeInString, b as resolveUserPath, h as normalizeE164, n as assertWebChannel, v as resolveHomeDir } from "./utils-BtIMES3N.js";
import "./pi-embedded-helpers-BubZUNx-.js";
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, I as CHANNEL_MESSAGE_ACTION_NAMES, It as waitForGatewayReachable, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, St as ensureWorkspaceAndSessions, Tr as lookupContextTokens, Tt as handleReset, at as CHANNEL_TARGETS_DESCRIPTION, cn as monitorWebChannel, dn as waitForever, ht as resolveCommitHash, jt as randomToken, on as registerMemoryCli, ot as CHANNEL_TARGET_DESCRIPTION, sn as runMemoryStatus, t as getReplyFromConfig, vt as DEFAULT_WORKSPACE, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-BJHSzh7M.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID, t as DEFAULT_ACCOUNT_ID } from "./session-key-BWxPj0z_.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-4V5EwH-r.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-D_p2LOiK.js";
import { Ft as DEFAULT_PROVIDER, H as resolveEnvApiKey, Nt as DEFAULT_CONTEXT_TOKENS, Ot as normalizeOptionalSecretInput, Pt as DEFAULT_MODEL, at as resolveAuthProfileOrder, d as resolveConfiguredModelRef, kt as normalizeSecretInput, s as normalizeProviderId, ut as resolveApiKeyForProfile, wt as resolveAuthStorePath, xt as ensureAuthProfileStore, yt as upsertAuthProfile } from "./model-selection-CTKoRqDI.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-BUuSkE19.js";
import { F as loadDotEnv, P as VERSION, c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-CmDYseI1.js";
...
import { D as deriveSessionKey, F as resolveFreshSessionTotalTokens, O as resolveSessionKey, d as loadSessionStore, m as saveSessionStore } from "./sandbox-4W8S1yx4.js";
import { d as installUnhandledRejectionHandler, v as applyTemplate } from "./runner-DNThkTtX.js";
import "./image-BFquFRGY.js";
import "./pi-model-discovery-EwKVHlZB.js";
import { c as describePortOwner, l as ensurePortAvailable, s as PortInUseError, u as handlePortError } from "./chrome-BtcIWBGj.js";
import "./skills-Dz15dAM4.js";
import "./routes-onyxaWpE.js";
import { r as formatUncaughtError } from "./errors-Bv81hF2P.js";
import { n as movePathToTrash } from "./server-context-B5b9OM_w.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-CTtrEkmW.js";
import "./logging-fywhKCmE.js";
import "./accounts-54zZMYCo.js";
import { c as resolveStorePath, o as resolveSessionTranscriptsDir, s as resolveSessionTranscriptsDirForAgent } from "./paths-DdKf4lHp.js";
import "./redact-BRsnXqwD.js";
import "./tool-display-kpW5Hg2z.js";
import "./fetch-TYcqD9fC.js";
import "./deliver-Btwgh8AF.js";
import "./dispatcher-DvPKt7RZ.js";
import "./manager-6brp4Eij.js";
import "./sqlite-CASnHrgX.js";
import "./commands-registry-DwM7YArf.js";
import "./client-_wavkSyB.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-tAGBQPmT.js";
...
import "./pi-tools.policy-BFjunfHK.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-lSlXMhsd.js";
import "./pairing-labels-XkKxEWhj.js";
import "./session-cost-usage-BYUb7fov.js";
import "./nodes-screen-DsHJIN2I.js";
import { _ as promptYesNo, g as ensureBinary } from "./auth-DWxmgKrO.js";
import "./control-auth-C4WYidv4.js";
import "./control-service-DbHg7sY9.js";
import "./channel-selection-C3umWMS0.js";
import { t as createDefaultDeps } from "./deps-BkKXWFia.js";
import { t as isMainModule } from "./is-main-BWoXGz7p.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BRKerjt1.js";
import { a as gatewayInstallErrorHint, g as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DNkQBUkt.js";
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-pbjVZbQ4.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-HyeZXsnu.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-DEPo2hji.js";
import "./note-uC6iDp4y.js";
import { t as WizardCancelledError } from "./prompts-Bg96reub.js";
import { t as createClackPrompter } from "./clack-prompter-B-tJmODa.js";
import { S as promptAuthChoiceGrouped, _ as applyAuthChoice, a as CustomApiError, b as detectZaiEndpoint, g as warnIfModelConfigLooksOff, l as resolveCustomProviderId, o as applyCustomApiConfig, s as parseNonInteractiveCustomApiFlags, v as applyOpenAIConfig, x as applyGoogleGeminiModelDefault, y as upsertSharedEnvVar } from "./onboard-skills-VdOPariR.js";
import { A as applyOpenrouterConfig, B as applyXaiConfig, D as applyMoonshotConfigCn, E as applyMoonshotConfig, H as applyXiaomiConfig, I as applyTogetherConfig, J as applyCloudflareAiGatewayConfig, K as applyLitellmConfig, M as applyQianfanConfig, Mt as buildTokenProfileId, Nt as validateAnthropicSetupToken, P as applySyntheticConfig, R as applyVeniceConfig, S as applyHuggingfaceConfig, St as setZaiApiKey, W as applyZaiConfig, X as applyVercelAiGatewayConfig, _ as applyMinimaxApiConfig, _t as setTogetherApiKey, at as setAnthropicApiKey, bt as setXaiApiKey, ct as setHuggingfaceApiKey, dt as setMinimaxApiKey, ft as setMoonshotApiKey, gt as setSyntheticApiKey, h as applyOpencodeZenConfig, ht as setQianfanApiKey, lt as setKimiCodingApiKey, mt as setOpenrouterApiKey, ot as setCloudflareAiGatewayConfig, pt as setOpencodeZenApiKey, st as setGeminiApiKey, ut as setLitellmApiKey, vt as setVeniceApiKey, w as applyKimiCodeConfig, x as applyAuthProfileConfig, xt as setXiaomiApiKey, y as applyMinimaxConfig, yt as setVercelAiGatewayApiKey } from "./openai-codex-oauth-n1IuMNem.js";
import { n as setupChannels } from "./onboard-channels-DE-boO98.js";
import "./plugin-auto-enable-DGk4w37p.js";
import "./archive-beaSfAzA.js";
import "./skill-scanner-CucvxYhu.js";
import "./installs-DsIhz365.js";
import { l as healthCommand } from "./health-format-BZ_Q7GD8.js";
import "./update-runner-DeCtsPt9.js";
import "./audit-M_67MoOZ.js";
import { t as renderTable } from "./table-BIk8Aan_.js";
import "./skills-status-ChM7JE47.js";
import { t as resolveGatewayService } from "./service-6LexomJs.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-4esm7UkF.js";
import "./service-audit-D72EQIK3.js";
import "./node-service-BMIEJX3_.js";
import "./channels-status-issues-Cs9Skq7X.js";
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-DzEDn1_H.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-D0d6N32R.js";
import { t as formatHelpExamples } from "./help-format-DYBEvMOX.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BNS7Iuc_.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-DEN6Dr5z.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-8O7IVGO-.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-DWUU0XC9.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-B_y6edwo.js";
import "./widearea-dns-Ypwgjpsr.js";
import "./auth-health-CTTtVxra.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-bE9aIg03.js";
import "./hooks-status-DPJORMB6.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-DWUU0XC9.js").then((n) => n.t);
