import { c as expandHomePrefix, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-BZtyHNCi.js";
import { M as normalizeAgentId, T as DEFAULT_AGENT_ID } from "./agent-scope-CmO3C9bx.js";
...
function resolveSessionFilePathOptions(params) {
	...
	if (storePath) return { sessionsDir: path.dirname(path.resolve(storePath)) };
...
//#endregion
export { resolveSessionTranscriptsDirForAgent as a, resolveSessionTranscriptPath as i, resolveSessionFilePath as n, resolveStorePath as o, resolveSessionFilePathOptions as r, resolveDefaultSessionStorePath as t };