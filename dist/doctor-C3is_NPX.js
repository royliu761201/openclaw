import { G as resolveGatewayPort, I as CONFIG_PATH, J as resolveNewStateDir, K as resolveIsNixMode, N as getResolvedLoggerSettings, Y as resolveOAuthDir, Z as resolveStateDir, ht as resolveRequiredHomeDir, n as isTruthyEnvValue, p as defaultRuntime, q as resolveLegacyStateDirs } from "./entry.js";
import { F as resolveConfiguredModelRef, Ft as CODEX_CLI_PROFILE_ID, L as resolveHooksGmailModel, Mt as DEFAULT_PROVIDER, O as getModelRefStatus, Pt as CLAUDE_CLI_PROFILE_ID, b as updateAuthProfileStoreWithLock, f as repairOAuthProfileIdMismatch, jt as DEFAULT_MODEL, o as resolveProfileUnusableUntilForDisplay, s as resolveApiKeyForProfile, v as ensureAuthProfileStore } from "./auth-profiles-DIgZUMSR.js";
...
import { C as sleep, S as shortenHomePath, _ as resolveHomeDir$1, d as isRecord } from "./utils-BLJAc3ZV.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CPPvAI1K.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-BKsZvO6K.js";
import { c as resolveDefaultAgentId, d as DEFAULT_AGENTS_FILENAME, s as resolveAgentWorkspaceDir } from "./agent-scope-DpnW8E9V.js";
import { c as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, u as OpenClawSchema } from "./config-TOMBPbi7.js";
import { l as resolveGatewayBindHost, r as isLoopbackHost } from "./ws-MC-rTJLe.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-xx1k4_sV.js";
import { i as resolveGatewayAuth } from "./auth-DS2aFsxs.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DHpd82Uy.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-Dx3c94r9.js";
import { n as listChannelPlugins } from "./plugins-haUgxMzs.js";
import { _ as randomToken, a as applyWizardMetadata, h as printWizardHeader, t as loadOpenClawPlugins, u as guardCancel } from "./loader-CFDxWA8T.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Cf1r1L6k.js";
import { t as note$1 } from "./note-Duiadw1g.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-ByYj2Aq5.js";
import { c as resolveStorePath, n as resolveSessionFilePath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BZK4Ct0I.js";
import { F as canonicalizeMainSessionAlias, K as resolveSandboxScope, R as resolveMainSessionKey, d as loadSessionStore, it as DEFAULT_SANDBOX_IMAGE, m as saveSessionStore, nt as DEFAULT_SANDBOX_BROWSER_IMAGE, rt as DEFAULT_SANDBOX_COMMON_IMAGE } from "./sandbox-udEhG_lJ.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-DV_TdlKm.js";
import { d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, l as resolveGatewayLaunchAgentLabel, m as resolveNodeLaunchAgentLabel } from "./constants-BvQ6S8j5.js";
import { _ as loadModelCatalog } from "./runner-Deyi6U-h.js";
import { i as readChannelAllowFromStore } from "./pairing-store--uxwA3DJ.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CPoNprEl.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DV9m8zhQ.js";
import { a as repairLaunchAgentBootstrap, i as launchAgentPlistExists, n as isLaunchAgentListed, o as resolveGatewayLogPaths, r as isLaunchAgentLoaded, t as resolveGatewayService } from "./service-CRQPieXI.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BNvgdkdy.js";
import { n as renderSystemdUnavailableHints, t as isSystemdUnavailableDetail } from "./systemd-hints-BVLopJ9O.js";
import { a as renderGatewayServiceCleanupHints, i as findExtraGatewayServices, n as auditGatewayServiceConfig, o as readLastGatewayErrorLine, r as needsNodeRuntimeMigration, t as SERVICE_AUDIT_CODES } from "./service-audit-tpVP1jqw.js";
import { i as resolveControlUiDistIndexPathForRoot, l as healthCommand, r as resolveControlUiDistIndexHealth, t as formatHealthCheckFailure } from "./health-format-dUH-zMGm.js";
import { f as doctorShellCompletion, t as runGatewayUpdate } from "./update-runner-Bnjr5SLD.js";
import { n as logConfigUpdated } from "./logging-B3KnAryz.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-B99Us6yS.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-BaJwObbE.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CBiLPxts.js";
