...
import { F as loadDotEnv, P as VERSION } from "./config-BDCbZ1IN.js";
...
import { m as installUnhandledRejectionHandler } from "./runner-CGRzVdkN.js";
...
import { a as getCommandPath, c as getPrimaryCommand, d as hasHelpOrVersion } from "./register.subclis-C6HFPvZP.js";
import "./completion-cli-M1uI95t2.js";
import "./gateway-rpc-2vsLL9Ek.js";
import "./deps-45EpC_d1.js";
import { h as assertSupportedRuntime } from "./daemon-runtime-CQtpMCvD.js";
...
import { a as findRoutedCommand, n as emitCliBanner, t as ensureConfigReady } from "./config-guard-B7IXgWQs.js";
...
async function runCli(argv = process$1.argv) {
	...
	const { buildProgram } = await import("./program-DSCqAOhj.js");
	...
	if (primary) {
		const { registerSubCliByName } = await import("./register.subclis-C6HFPvZP.js").then((n) => n.i);
		await registerSubCliByName(program, primary);
	}
	if (!(!primary && hasHelpOrVersion(parseArgv))) {
		const { registerPluginCliCommands } = await import("./cli-BwUL0zq7.js");
		const { loadConfig } = await import("./config-BDCbZ1IN.js").then((n) => n.t);
