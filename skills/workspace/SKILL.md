...
- 📥 **Global Task Loader**:
  `python3 /Users/roy-jd/Documents/projects/openclaw/skills/workspace/scripts/load_global_task.py --global_board <GLOBAL_BOARD_PATH> --session_task <BRAIN_PATH>/task.md`
...
- **Phase 1 (Loading)**: Run the loader script to pull `01_GLOBAL_TASK_BOARD.md` to your local session `task.md` with auto-resolved absolute URIs. ALWAYS run `ontology.py query --type Policy` as the pre-flight check.
  `python3 /Users/roy-jd/Documents/projects/openclaw/skills/workspace/scripts/load_global_task.py --global_board /Users/roy-jd/workspace/docs/system_core/memory_core/01_GLOBAL_TASK_BOARD.md --session_task <SESSION_BRAIN_PATH>/task.md`
