...
- **Concept**: Reconstruct regulatory networks using _Actionable Causality_ not just correlation.
...
_This skill replaces the legacy `ResearchBot` Python scripts (`patent_writer.py`, `grant_writer.py`, etc.). All logic is now driven by LLM reasoning using these standards._
