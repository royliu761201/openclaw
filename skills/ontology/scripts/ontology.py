...
import os
DEFAULT_GRAPH_PATH = os.path.expanduser("~/workspace/docs/system_core/memory_core/ontology/graph.jsonl")
DEFAULT_SCHEMA_PATH = os.path.expanduser("~/workspace/docs/system_core/memory_core/ontology/schema.yaml")
